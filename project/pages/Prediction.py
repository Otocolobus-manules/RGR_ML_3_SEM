...
if model == "Модель регресии":
    ...
    if data is "Except":
        ...
        model = stm.sidebar.radio("Модели", options=("Информационное окно",
                                                     ...
                                                     "Модель классического обучения без учителя(Kmeans)",
        ...
        match model:
            ...
            case "Модель классического обучения без учителя(KMeans)":
    ...
    if data is "Except":
        ...
        model = stm.sidebar.radio("Модели", options=("Информационное окно",
                                                     "Модель классического обучения с учителем(KNN)",
    ...
    if model == "Модель регресии":
        ...
        cut = stm.radio("cut(бриллиантовая огранка) принимает значения от 0 до 4 где: ( "
                        "Fair: 0, "
                        "Good: 1, "
                        "Very Good: 2, "
                        "Premium: 3, "
                        "Ideal: 4 )", options=(0, 1, 2, 3, 4), horizontal=True)

        color = stm.radio("color(цвет) принимает значения от 0 до 6 где: ( "
                          "E: 0, "
                          "I: 1, "
                          "J: 2, "
                          "H: 3, "
                          "F: 4, "
                          "G: 5, "
                          "D: 6 )", options=(0, 1, 2, 3, 4, 5, 6), horizontal=True)

        clarity = stm.radio("clarity(прозрачность)принимает значения от 0 до 7 где: ( "
                            "SI2: 0, "
                            "SI1: 1, "
                            "VS2: 2, "
                            "VS1: 3, "
                            ...
                            "VVS1: 5, "
                            "I1: 6, "
                            "IF: 7 )", options=(0, 1, 2, 3, 4, 5, 6, 7), horizontal=True)
